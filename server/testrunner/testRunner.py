...
import os
import sys
sys.path.append('../file_manager/file_manager_module')
import file_manager
...
if __name__ == '__main__':
    ...
    #os.system('cp sample_output/* ../file_manager/file_manager_module') #copies files from output folder to the file manager
    print("asdf")
    file_manager.sort_hierarchy()
